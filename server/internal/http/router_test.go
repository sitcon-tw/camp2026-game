...
func TestMatchRoutesRequireAuthentication(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{method: http.MethodPost, path: "/api/matches/multiplayer/pairings"},
		...
		{method: http.MethodPost, path: "/api/matches/M8RXP2/computer-players"},
		{method: http.MethodPost, path: "/api/matches/M8RXP2/rematch"},
