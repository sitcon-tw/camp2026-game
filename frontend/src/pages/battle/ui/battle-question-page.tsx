...
export function BattleQuestionPage() {
  ...
  if (!matchID) {
    return (
      <GamePageShell contentClassName="grid content-start gap-y-2 pb-[calc(1.125rem+env(safe-area-inset-bottom))]">
        <Card>
  ...
  return (
    <GamePageShell contentClassName="grid min-h-svh grid-rows-[auto_minmax(0,1fr)_auto] gap-y-2 px-2 pb-[calc(1.125rem+env(safe-area-inset-bottom))]">
      <PlayerRail
        label="對手"
