...
const detailMessageMap: Record<string, string> = {
  ...
  "insufficient open power for transfer": "開源力不足，無法轉帳。",
  ...
  "room team token not found":
    "找不到這個宿舍 QR Code，請確認是否已過期或掃描正確。",
  ...
  "cannot transfer open power to self": "不能轉帳給自己。",
  "open power transfer failed": "開源力轉帳失敗，請稍後再試。",
  "open power transfers require same team": "只能轉帳給同組成員。",
  "open power transfers unavailable": "轉帳紀錄暫時無法讀取，請稍後再試。",
  "recipient player not found": "找不到收款玩家。",
...
const codeMessageMap: Record<string, string> = {
  ...
  open_power_transfer_failed: "開源力轉帳失敗，請稍後再試。",
