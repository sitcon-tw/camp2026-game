      ...
      <DialogContent className="max-h-[86dvh] gap-3 overflow-y-auto p-4 sm:p-6">
        ...
        {mapMode === "territory_grid" ? (
          <div className="grid gap-0">
            <RuleRow icon={MoveUpRight} title="擴張" badge="10 小隊能量">
              選擇中立區域，從最接近該方向的我方邊界取得相連領土。
            </RuleRow>
            <RuleRow icon={Swords} title="攻擊" badge="15 小隊能量">
              選擇已與我方接壤的敵隊領土，削弱或佔領該方向的敵方邊界。
            </RuleRow>
            <RuleRow icon={ShieldPlus} title="防守" badge="最多 8 小隊能量">
            ...
            <RuleRow icon={Zap} title="小隊戰線能量">
              這是全隊共享、只用於戰線的能量，和首頁、商店的個人開源力分開計算；個人開源力不會解鎖戰線命令。能量不足時，本場可自動使用一次
              30 點基地補給。
            </RuleRow>
          ...
          <div className="grid gap-0">
            ...
            <RuleRow icon={Zap} title="小隊戰線能量">
              戰線命令使用全隊共享的戰線能量，和首頁、商店的個人開源力分開計算；命令花費與資源回收都會反映在小隊餘額。
            </RuleRow>
